...
<div class="sl-mainpanel">
 ...
 <h2>Research Information</h2>
          ...
          <div class="box-body"><!-- Nav tabs -->
					...
					<!-- Tab panes -->
							<div class="p-15">
              <form method="post" action="{{ route('lecturer.research.store') }}">
	 	@csrf
            ...
            <div class="row mg-b-25">
              <div class="col-lg-4">
                <div class="form-group">
                  ...
                  <input class="form-control" type="text" name="title[]" placeholder="Enter Research Title">
                </div>
              </div><!-- col-4 -->
              <div class="col-lg-4">
                <div class="form-group mg-b-10-force">
                  <label class="form-control-label">Role: <span class="tx-danger">*</span></label>
                  <select name="role[]" class="form-control select2 select2-hidden-accessible" data-placeholder="Choose Role" tabindex="-1" aria-hidden="true">
                    <option selected="" disabled="" label="Choose Role"></option>
