...
<div class="sl-logo"><a href="{{route('index')}}"><i class="icon ion-android-star-outline"></i> PSM MS</a></div>
    <div class="sl-sideleft">
      ...
      <div class="sl-sideleft-menu">
        <a href="{{route('index')}}" class="sl-menu-link active">
        ...
        <a href="{{ route('approval.submit') }}" class="sl-menu-link">
          <div class="sl-menu-item">
            <i class="menu-item-icon icon ion-ios-checkmark-outline tx-20"></i>
            <span class="menu-item-label">APPROVAL & REPORT</span>
          </div><!-- menu-item -->
        </a><!-- sl-menu-link -->
        <a href="{{ route('savelogbook') }}" class="sl-menu-link">
          <div class="sl-menu-item">
